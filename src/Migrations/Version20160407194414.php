...
class Version20160407194414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE CalendarExport (id INT AUTO_INCREMENT NOT NULL, exportNew TINYINT(1) NOT NULL, exportAbsence TINYINT(1) NOT NULL, secret VARCHAR(100) NOT NULL, accountId INT NOT NULL, INDEX IDX_6E28848862DEB3E8 (accountId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE GuildCharacter (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, realm VARCHAR(255) NOT NULL, fromTime DATETIME NOT NULL, endTime DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE FeatureToggle (id INT AUTO_INCREMENT NOT NULL, feature VARCHAR(255) NOT NULL, toggle TINYINT(1) NOT NULL, toggleFor INT NOT NULL, INDEX IDX_D25E05DD612E729E (toggleFor), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE FeatureUse (id INT AUTO_INCREMENT NOT NULL, usedOn DATETIME NOT NULL, feature VARCHAR(255) NOT NULL, rawData LONGTEXT DEFAULT NULL, usedBy INT DEFAULT NULL, INDEX IDX_E504F432FCEF271C (usedBy), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Feedback (id INT AUTO_INCREMENT NOT NULL, postedOn DATETIME NOT NULL, feedback LONGTEXT NOT NULL, postedBy INT NOT NULL, INDEX IDX_2B5F260E9DD8CB47 (postedBy), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ForRole (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(15) NOT NULL, signUpId INT NOT NULL, INDEX IDX_16186B55A966702F (signUpId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE GameClass (id INT NOT NULL, name VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE GameRace (id INT NOT NULL, name VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE MailSend (id INT AUTO_INCREMENT NOT NULL, sendOn DATETIME NOT NULL, fromAddress VARCHAR(255) NOT NULL, toAddress VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE PlaysRole (id INT AUTO_INCREMENT NOT NULL, fromTime DATETIME NOT NULL, endTime DATETIME DEFAULT NULL, role VARCHAR(15) NOT NULL, claimId INT NOT NULL, INDEX IDX_7A9E9B239113A92D (claimId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Setting (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, value VARCHAR(2048) NOT NULL, accountId INT NOT NULL, INDEX IDX_50C9810462DEB3E8 (accountId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE SignUp (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(15) NOT NULL, eventId INT NOT NULL, accountId INT NOT NULL, INDEX IDX_DC8B3F7B2B2EBB6C (eventId), INDEX IDX_DC8B3F7B62DEB3E8 (accountId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ForumLastVisit (visitId CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', lastVisitDate DATETIME NOT NULL, accountId INT NOT NULL, INDEX IDX_F17408662DEB3E8 (accountId), PRIMARY KEY(visitId)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE CommentGroup (groupId CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', postDate DATETIME NOT NULL, PRIMARY KEY(groupId)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ENGINE = InnoDB');
